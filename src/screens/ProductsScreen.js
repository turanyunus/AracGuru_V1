            ...
            <View style={styles.mainView}>
                <ScrollView showsVerticalScrollIndicator={false} style={styles.scrollStyle}>
                    <Header
                        ...
                        centerComponent={<Text style={styles.headerTitleStyle}>Ürünler</Text>}
                    ...
                    <View style={styles.container}>
                        <Image style={styles.images}
                               source={Platform.OS=='ios'?require('./../../assets/images/car-product.png'):require('./../../assets/images/car-product.png')}/>
                        <Text style={styles.comingSoon}>Çok Yakında ! </Text>
                        <Text style={styles.emptyMessage}>Araç yedek parçaları burada ! </Text>
                    </View>
                </ScrollView>
            </View>
        );
